...
import com.weidongjian.weigan.sunshine.Data.WeatherContract.LocationEntry;
import com.weidongjian.weigan.sunshine.Data.WeatherContract.WeatherEntry;
...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_LOCATION_TABLE = "CREATE TABLE " + LocationEntry.TABLE_NAME + " (" +
                ...
                "UNIQUE (" + LocationEntry.COLUMN_SETTING +") ON CONFLICT IGNORE" +
                " );";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        ...
        sqLiteDatabase.execSQL("DROP TABLE IF EXIT " + LocationEntry.TABLE_NAME);

...
//                context.getString(R.string.pref_location_default));
        String locationId = prefs.getString(context.getString(R.string.pref_city_key), context.getString(R.string.pref_city_default));
        return locationId.substring(3);
    }
